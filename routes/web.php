...
Route::patch('/admin/{user}/set-admin', [AdminController::class, 'setAdmin'])
    ->name('admin.setAdmin')
...
Route::get('/article/search', [ArticleController::class, 'search'])->middleware('throttle:search');
...
Route::middleware(['admin','admin.local'])->group(function(){
    ...
    Route::get('/admin/{user}/set-admin', [AdminController::class, 'setAdmin']);
